...
export default function Footer() {
    ...
    const {
     ...
     const footerItems = [
        ...
        },
        {
            ...
            spanText: "GitHub",
            onClick: () => {
                window.open('https://github.com/dhruvin-sarkar', '_blank');
        ...
        {
            className: "linkedin",
            imgSrc: 'https://cdn-icons-png.flaticon.com/512/174/174857.png',
            imgAlt: "LinkedIn",
            style: { width: '16px', height: '16px', borderRadius: '2px' },
            spanText: "LinkedIn",
            onClick: () => {
                window.open('https://www.linkedin.com/in/dhruvin-sarkar/', '_blank');
                setStartActive(false)
            },
            onmouseenter: () => {
                setResumejectStartBar(false);
    ...
    useEffect(() => { //random clippy time
        ...
        const CLIPPY_MIN_INTERVAL_MS = 55000;
        const CLIPPY_MAX_INTERVAL_MS = 90000;
        const randomTime = Math.floor(
            Math.random() * (CLIPPY_MAX_INTERVAL_MS - CLIPPY_MIN_INTERVAL_MS + 1)
        ) + CLIPPY_MIN_INTERVAL_MS;
    ...
    const iconSizeSelection = [
        { label: '360x640', value: 0 },
        { label: '640x720', value: 1 },
        { label: '1920x1080', value: 2 },
        { label: '2560x1440', value: 3 },
        { label: '3840x2160', value: 4 }
    ];
                ...
                >
                    <div className="icon_time_container">
                        ...
                        <img 
                            ...
                            style={{
                                width: '16px',
                                opacity: sounds?.muted ? 0.5 : 1,
                                cursor: 'pointer'
                            }}
                            onClick={(e) => {
                                e.stopPropagation()
                                setVolumePopup(!volumePopup)
                                setIconSize(false)
                                setStartActive(false)
                                setCalenderToggle(false)
                            }}
            ...
            {volumePopup && (
                ...
                >
                    ...
                    <div style={{
                        ...
                        />
                        <style>{`
                            .volume_container input[type="range"]::-webkit-slider-track {
                                width: 100%;
                                height: 4px;
                                background: #c0c0c0;
                                border: 1px solid;
                            ...
                            .volume_container input[type="range"]::-webkit-slider-thumb {
                            ...
                            .volume_container input[type="range"]::-moz-range-track {
                                width: 100%;
                                height: 4px;
                                background: #c0c0c0;
                                border: 1px solid;
                            ...
                            .volume_container input[type="range"]::-moz-range-thumb {
                                width: 12px;
                                height: 18px;
                                background: #c0c0c0;
                                border: 2px solid;
                    ...
                    <div style={{
                        ...
                        <span>Low</span>
                        <span style={{fontWeight: 'bold'}}>{sounds?.volume || 50}%</span>
                        <span>High</span>
                    </div>
                    <button
                        ...
                        onMouseDown={(e) => {
                            ...
                            e.currentTarget.style.padding = '7px 5px 5px 7px';
                        }}
                        onMouseUp={(e) => {
