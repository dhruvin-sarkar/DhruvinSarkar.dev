...
const form = useRef();
  ...
  const sendEmail = (e) => {
    ...
    emailjs
      .sendForm('service_d03e24h', 'template_f290ilr', form.current, {
            ...
            <form ref={form} onSubmit={sendEmail}>
              ...
              <div className="form_container">
                ...
                <div className="sendmail_icon">
                  ...
                  <input className="myemail_container" placeholder='dhruvinsarkar@outlook.com' disabled style={{background: '#d4d1d1'}} />
                </div>
                <div className="to_container">
