...
function ErrorBtn({themeDragBar, stateVal, text, setStateVal, runOpenFuction}) {
    ...
    const textGithub = "Warning: You will be redirected to Dhruvin's GitHub profile. Continue?"
    ...
    function handleFunction(name) {
        ...
        switch (name.toLowerCase()) {
            ...
            case "github": 
                return window.open('https://github.com/dhruvin-sarkar', '_blank');

            case "webresume": 
                return window.open('https://dhruvin-sarkar.github.io/Win95P-DevPortfolio', '_blank');
